...
alice = get_simple_text('test1.txt')
frank = get_simple_text('test2.txt')
print(alice)
print(frank)
...
print(take(5, encrypt_key.items()))
...
print(take(5, letter_probs.items()))
...
print(score_text(alice_encrypted, letter_probs, bigram_probs))
